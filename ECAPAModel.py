...
from ecapa.model import ECAPA_TDNN
from tqdm import tqdm
import numpy as np
import pickle as pkl

class ECAPAModel(nn.Module):
        def __init__(self, lr=0.001, lr_decay=0.97, C=1024 , n_class=5994, m=0.2, s=30, test_step=1, **kwargs):
        ...
        def extract_embeddings(self, test_dataloader, out_file):
                self.eval()
                embs_dict = {}
